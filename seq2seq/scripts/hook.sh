...
BS=$((BS_*GA))
GC=true
OUT_DIR=outputs/afterqmultadd-afterwimultadd_${TASK}_${MODEL}_eps${EP}_lr${LR}_bs${BS}
mkdir -p $OUT_DIR
...
"use_mult": true,
"use_add": true,
"layer_list": "layer_norm,after_q_self_attn,after_q_cross_attn,after_wi_ffn",
...
OUT_DIR=outputs/b4omultadd-b4womultadd_${TASK}_${MODEL}_eps${EP}_lr${LR}_bs${BS}
mkdir -p $OUT_DIR
cat configs/bitfit.json > $OUT_DIR/settings.json
echo '"freeze_bitfit_lm_head": true,
"train_distributor": true,
"use_mult": true,
"use_add": true,
"layer_list": "layer_norm,b4_o_self_attn,b4_o_cross_attn,b4_wo_ffn",
"freeze_bitfit_lm_head": true,
"output_dir": "'${OUT_DIR}'",
"max_source_length": 128,
"task_name": "'${TASK}'",
